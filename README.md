...
The script generates synthetic weekly data for a single player, including features such as age, previous injuries, games played, minutes, average speed, training load, recovery days, and cumulative load. It calculates a risk score and injury probability for 12 historical weeks.

Two machine learning algorithms are trained on this data:
Logistic Regression – to model the probability of injury based on player workload and history.
Random Forest Classifier – to capture more complex, nonlinear relationships in the same data.
